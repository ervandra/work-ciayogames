 ...
 */
function ciayogames_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'ciayogames_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ciayogames-front-page) .entry-title,
...
.colors-custom .ciayogames-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ciayogames-front-page .panel-content .recent-posts article,
...
.colors-custom.ciayogames-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'ciayogames_custom_colors_css', $css, $hue, $saturation );
}
